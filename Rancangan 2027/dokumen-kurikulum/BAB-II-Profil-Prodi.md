...
## 2.3 Visi Program Studi

> **"Menjadi Program Studi Teknologi Informasi yang unggul, inovatif, dan berakhlak mulia dalam mengembangkan ilmu pengetahuan dan teknologi berbasis nilai-nilai Islam untuk kemaslahatan umat pada tahun 2032."**

### Penjelasan Visi

Makna setiap kata kunci dalam rumusan visi diuraikan pada Tabel 2.3 agar dapat dipahami dan diukur pencapaiannya.

**Tabel 2.3 — Penjelasan Kata Kunci Visi**
...
## 2.4 Misi Program Studi

1. **Menyelenggarakan pendidikan TI berkualitas** berbasis OBE yang mengintegrasikan nilai-nilai Al-Islam dan Kemuhammadiyahan untuk menghasilkan sarjana berkompetensi global.

2. **Mengembangkan penelitian** di bidang Teknologi Informasi — khususnya pada bidang unggulan: *e-health*, IoT, keamanan siber, kecerdasan buatan, dan pengembangan aplikasi — yang berorientasi pada solusi permasalahan masyarakat.

3. **Melaksanakan pengabdian kepada masyarakat** melalui penerapan TI untuk meningkatkan kualitas hidup, kesehatan, dan perekonomian masyarakat.

4. **Membangun kemitraan strategis** dengan industri, pemerintah, dan institusi pendidikan nasional maupun internasional guna meningkatkan relevansi dan kualitas lulusan.

5. **Menciptakan ekosistem inovasi** melalui inkubasi wirausaha berbasis TI yang menghasilkan wirausahawan muda berkarakter Islami.

6. **Menjamin mutu berkelanjutan** melalui sistem penjaminan mutu internal (*CQI*) dan evaluasi kurikulum secara periodik.

---

## 2.5 Tujuan Program Studi

Berdasarkan visi dan misi di atas, tujuan Program Studi S1 Teknologi Informasi adalah menghasilkan lulusan yang:

1. **T1** — Memiliki pengetahuan matematika dan komputasi yang kuat sebagai fondasi pemecahan masalah TI kompleks.
2. **T2** — Mampu menganalisis, merancang, dan mengevaluasi solusi sistem TI yang terintegrasi, aman, dan andal.
3. **T3** — Menguasai kompetensi inti bidang Teknologi Informasi: infrastruktur jaringan, keamanan siber, pengembangan aplikasi, dan manajemen data.
...
Sasaran program studi dijabarkan dalam Indikator Kinerja Utama (IKU) yang terukur beserta targetnya, sebagaimana disajikan pada Tabel 2.4.

**Tabel 2.4 — Sasaran dan Indikator Kinerja Utama (IKU) 2027–2032**

| Sasaran | Indikator Kinerja Utama (IKU) | Target 2027–2032 |
|---------|-------------------------------|------------------|
| Mutu Lulusan | Masa tunggu kerja pertama ≤ 3 bulan | ≥ 80% lulusan |
| Relevansi | Kesesuaian bidang kerja dengan TI | ≥ 70% |
| Kewirausahaan | Lulusan berwirausaha di bidang TI | ≥ 10% per angkatan |
| Akademik | IPK rata-rata lulusan | ≥ 3,30 |
| Masa Studi | Rata-rata masa studi | ≤ 4,5 tahun |
| Penelitian Dosen | Publikasi terindeks Sinta/Scopus | ≥ 5/tahun |
| Pengabdian Masyarakat | Kegiatan PKM berbasis TI | ≥ 3 kegiatan/tahun |
| Akreditasi | Peringkat BAN-PT | Unggul (2028) |
| Kerjasama Industri | MoU aktif dengan industri TI | ≥ 10 industri |
| MBKM | Mahasiswa ikut MBKM | ≥ 30% per angkatan |

---

## 2.7 Profil Lulusan (Ringkasan)

> **[AMANDEMEN]** Sesuai anjuran APTIKOM 2023 §5.1 (PL disarankan berjumlah 4–5, mencakup 4 aspek KKNI: Sikap, Pengetahuan, Keterampilan Umum, Keterampilan Khusus), Program Studi kini menetapkan **lima Profil Lulusan** — PL01 (Praktisi TI), PL02 (Wirausahawan TI), PL03 (Analis Data & Kecerdasan Buatan), **PL04 (Insan Berkarakter Islami dan Berwawasan Kebangsaan, unsur Sikap — baru)**, dan **PL05 (Profesional Pembelajar Sepanjang Hayat, unsur Keterampilan Umum — baru)**. Uraian lengkap kompetensi, karir representatif, dan matriks Profil Lulusan terhadap kebutuhan industri dibahas secara rinci pada **BAB III — Analisis Kebutuhan dan Profil Lulusan**, agar tidak terjadi duplikasi antar-bab.
...
Program studi didukung sejumlah laboratorium sesuai bidang keahlian, sebagaimana dirinci pada Tabel 2.9.

**Tabel 2.9 — Daftar Laboratorium Program Studi**
...
Selain laboratorium, tersedia fasilitas pendukung pembelajaran sebagaimana disajikan pada Tabel 2.10.

**Tabel 2.10 — Fasilitas Pendukung Pembelajaran**
...
## 2.11 Status Akreditasi

Status akreditasi program studi saat ini dan targetnya diringkas pada Tabel 2.12.

**Tabel 2.12 — Status Akreditasi Program Studi**
...
*Bab ini akan diperbarui setiap tahun akademik untuk memastikan data sumber daya, akreditasi, dan kemitraan selalu akurat.*
