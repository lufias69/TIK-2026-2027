...
| **CPMK032** | Mengimplementasikan solusi berbasis computing | 4 | Metodologi Penelitian (TIN5121, sem 5, 2 SKS); Teknologi Sistem Terintegrasi (TIN6130, sem 6, 2 SKS); Praktek Professional Global (TIN6132, sem 6, 2 SKS); Design User Experience (TIN7140, sem 7, 2 SKS) |
| **CPMK033** | Mengevaluasi solusi berbasis computing dari aspek keandalan, keamanan, dan efisiensi | 4 | Pemrograman Berorientasi Objek (PBO) (TIN303, sem 3, 4 SKS); Pemrograman Web Dasar (TIN304, sem 3, 4 SKS); Pemrograman Web Lanjut (TIN4120, sem 4, 4 SKS); Multimedia (TIN5247, sem 5, 4 SKS) |
...
| CPMK | Deskripsi Singkat | Jml MK | Mata Kuliah Pengampu (kode, semester, SKS) |
|------|--------------------|:---:|---------------------------------------------|
| **CPMK041** | Mengintegrasikan infrastruktur teknologi informasi (jaringan, server, platform, layanan) | 4 | Pemrograman Web Dasar (TIN304, sem 3, 4 SKS); Pemrograman Web Lanjut (TIN4120, sem 4, 4 SKS); Internet of Things (TIN6252, sem 6, 4 SKS); Aplikasi Seluler(Mobile) (TIN6253, sem 7, 4 SKS) |
...
`**` = MK dengan batas maksimum CPMK yang dilonggarkan dari SKS (lihat pengecualian §2.1).

| Sem | Kode | Mata Kuliah | SKS | Maks. CPMK (=SKS)\* | CPMK Ditugaskan | Jml |
|:---:|------|-------------|:---:|:---:|------------------|:---:|
...
| 1 | TIN1102 | Algoritma dan Pemrograman | 4 | 4 | CPMK011, CPMK014 | 2 |
...
| 2 | TIN2108 | Struktur Data | 4 | 4 | CPMK011, CPMK014 | 2 |
...
| 3 | TIN302 | Jaringan Komputer 1 | 4 | 4 | CPMK051, CPMK053 | 2 |
...
| 5 | TIN5248 | Jaringan Komputer 2 | 4 | 4 | CPMK051, CPMK053 | 2 |
...
| 6 | TIN6252 | Internet of Things | 4 | 4 | CPMK041 | 1 |
| 6 | TIN6254 | Sistem dan Layanan Virtual | 2 | 2 | CPMK052 | 1 |
| 7 | TIN6253 | Aplikasi Seluler(Mobile) | 4 | 4 | CPMK041 | 1 |
| 7 | TIN7138 | Sistem Web dan Seluler (Mobile) | 4 | 4 | CPMK042 | 1 |
...
| 7 | TIN7260 | Magang/Praktik Kerja | 4 | 4 | CPMK022, CPMK042 | 2 |
...
| 8 | TIN8144 | Skripsi | 4 | 4 | CPMK011, CPMK023 | 2 |

\* Kolom "Maks. CPMK" = batas jumlah CPMK maksimum yang boleh diampu MK tersebut (sama dengan jumlah SKS, kecuali 7 MK bertanda `**`).
...
| Total pasangan (CPMK, MK) teralokasi | 101 |
| CPMK dengan ≥4 MK | 23 dari 26 (CPMK081–083 = 3 MK, lihat pengecualian §2.1) |
| MK dengan 1 CPMK | 36 |
| MK dengan 2 CPMK | 22 |
| MK dengan 3 CPMK (AIK/Wajib Nasional, pengecualian) | 7 |
| MK dengan 0 CPMK | 0 ✅ |
...
5. MK dengan 4 SKS umumnya diberi 2 CPMK (bukan dimaksimalkan ke 4) untuk menjaga distribusi merata CPMK ke berbagai MK lain yang juga memerlukan cakupan (agar tidak ada CPMK yang menumpuk hanya di sedikit MK besar) — Tim Kurikulum berwenang menambah CPMK pada MK 4 SKS yang dirasa masih memiliki kapasitas (maks. hingga 4 CPMK) apabila dipandang perlu.
6. Dokumen ini bersifat **draf alokasi untuk validasi Tim Kurikulum** dan melengkapi (bukan menggantikan) `Pemetaan-CPMK.md` (metode dekomposisi CPL→CPMK resmi APTIKOM) dan `Pemetaan-Detail-Bahan-Kajian.md` (BK→CPL→MK).
